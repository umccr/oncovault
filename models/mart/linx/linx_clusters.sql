...
with transformed as (
    ...
    from {{ ref('hub_workflow_run') }} wfl
        ...
        join {{ ref('sat_linx_clusters') }} sat on sat.library_workflow_run_hk = lnk.library_workflow_run_hk
...
final as (
    ...
    select
        ...
        cast(synthetic as varchar) as synthetic,
        cast(resolved_type as varchar) as resolved_type,
        cast(cluster_count as double) as cluster_count,
        cast(cluster_desc as varchar) as cluster_desc
    from
        transformed
