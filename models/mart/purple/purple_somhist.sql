...
with transformed as (
    ...
    from {{ ref('hub_workflow_run') }} wfl
        ...
        join {{ ref('sat_purple_somhist') }} sat on sat.library_workflow_run_hk = lnk.library_workflow_run_hk
...
final as (
    ...
    select
        ...
        cast(variant_cn_bucket as double) as variant_cn_bucket,
        cast(cn_bucket as double) as cn_bucket,
